...
// $aula puede venir vacío desde el controlador create()
$aula = $aula ?? ['nombre' => '', 'descripcion' => '', 'capacidad' => 0];
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Nueva Aula</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <h5>Información de la nueva aula</h5>
            </div>
...
<!-- Validación en cliente (opcional, igual a tu ejemplo) -->
