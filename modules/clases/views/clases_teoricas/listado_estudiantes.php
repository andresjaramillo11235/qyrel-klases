        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= $routes['clases_teoricas_listado_instructores']; ?>">Clases Teóricas</a></li>
                    <li class="breadcrumb-item" aria-current="page">Listado estudiantes</li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <?php foreach ($estudiantes as $est): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ((int)$est['asistencia'] === 2): ?>
                                                <span class="badge bg-danger ms-2">No asistió</span>
                                                <!-- Si usas Bootstrap 5.2+, puedes usar: badge text-bg-danger -->
                                            <?php endif; ?>
                                        </td>
