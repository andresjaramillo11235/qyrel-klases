                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item px-0 pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p class="mb-0"> <?= $estudiante['numero_documento'] ?></p>
                                            </div>
                                        </div>
                                    </li>

                                    <!-- Despartamento - ciudad de expedicion -->
                                    ...
                                    <!-- Fecha de expedicion - grupo sanguineo -->
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <!-- Direccion de residencia - direccion de oficina -->
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <!-- Seguridad social - nivel de educacion -->
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <!--Nombre del contacto - telefono del contacto -->
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-md-6">
